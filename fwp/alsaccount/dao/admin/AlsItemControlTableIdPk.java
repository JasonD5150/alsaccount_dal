...
/**
 * AlsItemControlTableIdPk entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class AlsItemControlTableIdPk implements java.io.Serializable {
	...
	/** default constructor */
	public AlsItemControlTableIdPk() {
	}

	/** full constructor */
	public AlsItemControlTableIdPk(Timestamp aictUsagePeriodFrom,
			Timestamp aictUsagePeriodTo, String aictItemTypeCd) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlsItemControlTableIdPk))
			return false;
		AlsItemControlTableIdPk castOther = (AlsItemControlTableIdPk) other;
