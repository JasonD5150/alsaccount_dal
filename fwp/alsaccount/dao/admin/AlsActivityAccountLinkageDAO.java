...
/**
	 ...
	 * @see fwp.alsaccount.dao.admin.AlsActivityAccountLinkage
...
public class AlsActivityAccountLinkageDAO extends BaseHibernateDAO  {
    ...
    public AlsActivityAccountLinkage findById( fwp.alsaccount.dao.admin.AlsActivityAccountLinkageIdPk id) {
        ...
        try {
            AlsActivityAccountLinkage instance = (AlsActivityAccountLinkage) getSession()
                    .get("fwp.alsaccount.dao.admin.AlsActivityAccountLinkage", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<AlsActivityAccountLinkage> findByExample(AlsActivityAccountLinkage instance) {
        ...
        try {
            List<AlsActivityAccountLinkage> results = (List<AlsActivityAccountLinkage>) getSession()
                    .createCriteria("fwp.alsaccount.dao.admin.AlsActivityAccountLinkage")
                    .add( create(instance) )
            .list();
