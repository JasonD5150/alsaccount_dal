...
public class AlsTribeItemInfoIdPk  implements java.io.Serializable {
    ...
    /** full constructor */
    public AlsTribeItemInfoIdPk(Timestamp aictUsagePeriodFrom, Timestamp aictUsagePeriodTo, String aictItemTypeCd) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AlsTribeItemInfoIdPk) ) return false;
