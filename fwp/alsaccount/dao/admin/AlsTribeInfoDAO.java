...
public class AlsTribeInfoDAO extends BaseHibernateDAO {
	...
	public List<AlsTribeInfo> findByExample(AlsTribeInfo instance) {
		log.debug("finding AlsTribeInfo instance by example");
		try {
			List<AlsTribeInfo> results = (List<AlsTribeInfo>) getSession()
	...
	public List<AlsTribeInfo> findByAtiTribeNm(Object atiTribeNm) {
		return findByProperty(ATI_TRIBE_NM, atiTribeNm);
	}

	public List<AlsTribeInfo> findByAbcBankCd(Object abcBankCd) {
		return findByProperty(ABC_BANK_CD, abcBankCd);
	}

	public List<AlsTribeInfo> findByAtiDirectorNm(Object atiDirectorNm) {
		return findByProperty(ATI_DIRECTOR_NM, atiDirectorNm);
	}

	public List<AlsTribeInfo> findByAtiWhoLog(Object atiWhoLog) {
		return findByProperty(ATI_WHO_LOG, atiWhoLog);
	}

	public List<AlsTribeInfo> findByAtiTribeAcctBankNm(Object atiTribeAcctBankNm) {
		return findByProperty(ATI_TRIBE_ACCT_BANK_NM, atiTribeAcctBankNm);
	}

	public List<AlsTribeInfo> findByAtiTribeAcctRoutingNo(
			Object atiTribeAcctRoutingNo) {
		return findByProperty(ATI_TRIBE_ACCT_ROUTING_NO, atiTribeAcctRoutingNo);
	}

	public List<AlsTribeInfo> findByAtiTribeAcctNo(Object atiTribeAcctNo) {
