...
/**
	 ...
	 * @see fwp.alsaccount.hibernate.dao.AlsSysActivityTypeTranCds
...
public class AlsSysActivityTypeTranCdsDAO extends BaseHibernateDAO  {
    ...
    public AlsSysActivityTypeTranCds findById( fwp.alsaccount.hibernate.dao.AlsSysActivityTypeTranCdsIdPk id) {
        ...
        try {
            AlsSysActivityTypeTranCds instance = (AlsSysActivityTypeTranCds) getSession()
                    .get("fwp.alsaccount.hibernate.dao.AlsSysActivityTypeTranCds", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<AlsSysActivityTypeTranCds> findByExample(AlsSysActivityTypeTranCds instance) {
        ...
        try {
            List<AlsSysActivityTypeTranCds> results = (List<AlsSysActivityTypeTranCds>) getSession()
                    .createCriteria("fwp.alsaccount.hibernate.dao.AlsSysActivityTypeTranCds")
                    .add( create(instance) )
            .list();
