...
/**
	 ...
	 * @see fwp.als.hibernate.admin.dao.AlsSysActivityControl
    ...
    public AlsSysActivityControl findById( fwp.alsaccount.hibernate.dao.AlsSysActivityControlIdPk id) {
        ...
        try {
            AlsSysActivityControl instance = (AlsSysActivityControl) getSession()
                    .get("fwp.als.hibernate.admin.dao.AlsSysActivityControl", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<AlsSysActivityControl> findByExample(AlsSysActivityControl instance) {
        ...
        try {
            List<AlsSysActivityControl> results = (List<AlsSysActivityControl>) getSession()
                    .createCriteria("fwp.als.hibernate.admin.dao.AlsSysActivityControl")
                    .add( create(instance) )
            .list();
